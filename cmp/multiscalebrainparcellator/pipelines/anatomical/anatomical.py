    ...
    def create_pipeline_flow(self,deriv_subject_directory):
        ...
        if self.stages['Segmentation'].config.seg_tool == "Freesurfer":
            sinker.inputs.substitutions = [ ('T1.nii.gz', self.subject+'_T1w_space-orig_desc-head.nii.gz'),
                                            ...
                                            ('ROIv_HR_th_scale1.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-1_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale2.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-2_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale3.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-3_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale4.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-4_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale5.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-5_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale1_final.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-1_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale2_final.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-2_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale3_final.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-3_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale4_final.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-4_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale5_final.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-5_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale1.graphml',self.subject+'_T1w_space-orig_label-L2018_scale-1_atlas.graphml'),
                                            ('ROIv_HR_th_scale2.graphml',self.subject+'_T1w_space-orig_label-L2018_scale-2_atlas.graphml'),
                                            ('ROIv_HR_th_scale3.graphml',self.subject+'_T1w_space-orig_label-L2018_scale-3_atlas.graphml'),
                                            ('ROIv_HR_th_scale4.graphml',self.subject+'_T1w_space-orig_label-L2018_scale-4_atlas.graphml'),
                                            ('ROIv_HR_th_scale5.graphml',self.subject+'_T1w_space-orig_label-L2018_scale-5_atlas.graphml'),
                                            ('ROIv_HR_th_scale1_FreeSurferColorLUT.txt',self.subject+'_T1w_space-orig_label-L2018_scale-1_atlas_FreeSurferColorLUT.txt'),
                                            ('ROIv_HR_th_scale2_FreeSurferColorLUT.txt',self.subject+'_T1w_space-orig_label-L2018_scale-2_atlas_FreeSurferColorLUT.txt'),
                                            ('ROIv_HR_th_scale3_FreeSurferColorLUT.txt',self.subject+'_T1w_space-orig_label-L2018_scale-3_atlas_FreeSurferColorLUT.txt'),
                                            ('ROIv_HR_th_scale4_FreeSurferColorLUT.txt',self.subject+'_T1w_space-orig_label-L2018_scale-4_atlas_FreeSurferColorLUT.txt'),
                                            ('ROIv_HR_th_scale5_FreeSurferColorLUT.txt',self.subject+'_T1w_space-orig_label-L2018_scale-5_atlas_FreeSurferColorLUT.txt'),
                                            ('ROIv_HR_th_scale33.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-1_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale60.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-2_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale125.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-3_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale250.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-4_atlas.nii.gz'),
                                            ('ROIv_HR_th_scale500.nii.gz',self.subject+'_T1w_space-orig_label-L2018_scale-5_atlas.nii.gz'),
                                          ]
        else:
